...
// Se publican todos (con o sin foto): los que todavia no tienen foto
// muestran una tarjeta de "foto pendiente" con el nombre de la marca.
const VISIBLE_PRODUCTS_RAW = PRODUCTS.filter(p => !p.hidden);
